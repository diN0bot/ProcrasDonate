# modified from
#     http://snipplr.com/view/15274/python-convert-between-dict-and-xml-via-elementtree/
# plain code view: http://snipplr.com/view.php?codeview&id=15274
# posted by atr000 on 05/24/09 
...
def ConvertXmlToDict(root, dictclass=XmlDictObject):
    ...
    #if a string is passed in, try to parse xml
    if type(root) == type(''):
        root = ET.fromstring(root)
    # else, assume we have ET.Element <---which is a function not a type ?!
