...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RescueTimeUser.recipient'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['procrasdonate.Recipient'], null=True, blank=True))
        db.alter_column('rescuetime_interface_rescuetimeuser', 'recipient_id', orm['rescuetime_interface.rescuetimeuser:recipient'])
