...
urlpatterns = patterns('',
    ...
    url(r'^recipient/register/$', fps.recipient_register, name='recipient_register'),
    # Callback from Co-Branded UI registration page
    url(r'^recipient/register_callback/$', fps.recipient_register_callback, name='recipient_register_callback'),
