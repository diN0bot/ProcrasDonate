...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TotalPDSiteGroup'
        db.create_table('procrasdonate_totalpdsitegroup', (
            ('id', orm['procrasdonate.totalpdsitegroup:id']),
            ('period', orm['procrasdonate.totalpdsitegroup:period']),
            ('total_pledged', orm['procrasdonate.totalpdsitegroup:total_pledged']),
            ('total_paid', orm['procrasdonate.totalpdsitegroup:total_paid']),
            ('total_time', orm['procrasdonate.totalpdsitegroup:total_time']),
            ('sitegroup', orm['procrasdonate.totalpdsitegroup:sitegroup']),
        ))
        db.send_create_signal('procrasdonate', ['TotalPDSiteGroup'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'TotalPDSiteGroup'
        db.delete_table('procrasdonate_totalpdsitegroup')
