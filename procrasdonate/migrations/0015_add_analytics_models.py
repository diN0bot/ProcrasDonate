...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Goal'
        db.create_table('procrasdonate_goal', (
            ('id', orm['procrasdonate.goal:id']),
            ('is_met', orm['procrasdonate.goal:is_met']),
            ('difference', orm['procrasdonate.goal:difference']),
            ('period', orm['procrasdonate.goal:period']),
            ('user', orm['procrasdonate.goal:user']),
        ))
        db.send_create_signal('procrasdonate', ['Goal'])
        
        # Adding model 'TotalSite'
        db.create_table('procrasdonate_totalsite', (
            ('id', orm['procrasdonate.totalsite:id']),
            ('period', orm['procrasdonate.totalsite:period']),
            ('total_pledged', orm['procrasdonate.totalsite:total_pledged']),
            ('total_paid', orm['procrasdonate.totalsite:total_paid']),
            ('total_time', orm['procrasdonate.totalsite:total_time']),
            ('site', orm['procrasdonate.totalsite:site']),
        ))
        db.send_create_signal('procrasdonate', ['TotalSite'])
        
        # Adding model 'Period'
        db.create_table('procrasdonate_period', (
            ('id', orm['procrasdonate.period:id']),
            ('type', orm['procrasdonate.period:type']),
            ('startdate', orm['procrasdonate.period:startdate']),
            ('enddate', orm['procrasdonate.period:enddate']),
        ))
        db.send_create_signal('procrasdonate', ['Period'])
        
        # Adding model 'TotalUser'
        db.create_table('procrasdonate_totaluser', (
            ('id', orm['procrasdonate.totaluser:id']),
            ('period', orm['procrasdonate.totaluser:period']),
            ('total_pledged', orm['procrasdonate.totaluser:total_pledged']),
            ('total_paid', orm['procrasdonate.totaluser:total_paid']),
            ('total_time', orm['procrasdonate.totaluser:total_time']),
            ('user', orm['procrasdonate.totaluser:user']),
            ('goals_met', orm['procrasdonate.totaluser:goals_met']),
            ('hours_saved', orm['procrasdonate.totaluser:hours_saved']),
        ))
        db.send_create_signal('procrasdonate', ['TotalUser'])
        
        # Adding model 'TotalSiteGroup'
        db.create_table('procrasdonate_totalsitegroup', (
            ('id', orm['procrasdonate.totalsitegroup:id']),
            ('period', orm['procrasdonate.totalsitegroup:period']),
            ('total_pledged', orm['procrasdonate.totalsitegroup:total_pledged']),
            ('total_paid', orm['procrasdonate.totalsitegroup:total_paid']),
            ('total_time', orm['procrasdonate.totalsitegroup:total_time']),
            ('sitegroup', orm['procrasdonate.totalsitegroup:sitegroup']),
        ))
        db.send_create_signal('procrasdonate', ['TotalSiteGroup'])
        
        # Adding model 'TotalRecipient'
        db.create_table('procrasdonate_totalrecipient', (
            ('id', orm['procrasdonate.totalrecipient:id']),
            ('period', orm['procrasdonate.totalrecipient:period']),
            ('total_pledged', orm['procrasdonate.totalrecipient:total_pledged']),
            ('total_paid', orm['procrasdonate.totalrecipient:total_paid']),
            ('total_time', orm['procrasdonate.totalrecipient:total_time']),
            ('recipient', orm['procrasdonate.totalrecipient:recipient']),
        ))
        db.send_create_signal('procrasdonate', ['TotalRecipient'])
        
        # Adding model 'TotalTag'
        db.create_table('procrasdonate_totaltag', (
            ('id', orm['procrasdonate.totaltag:id']),
            ('period', orm['procrasdonate.totaltag:period']),
            ('total_pledged', orm['procrasdonate.totaltag:total_pledged']),
            ('total_paid', orm['procrasdonate.totaltag:total_paid']),
            ('total_time', orm['procrasdonate.totaltag:total_time']),
            ('tag', orm['procrasdonate.totaltag:tag']),
        ))
        db.send_create_signal('procrasdonate', ['TotalTag'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Goal'
        db.delete_table('procrasdonate_goal')
        
        # Deleting model 'TotalSite'
        db.delete_table('procrasdonate_totalsite')
        
        # Deleting model 'Period'
        db.delete_table('procrasdonate_period')
        
        # Deleting model 'TotalUser'
        db.delete_table('procrasdonate_totaluser')
        
        # Deleting model 'TotalSiteGroup'
        db.delete_table('procrasdonate_totalsitegroup')
        
        # Deleting model 'TotalRecipient'
        db.delete_table('procrasdonate_totalrecipient')
        
        # Deleting model 'TotalTag'
        db.delete_table('procrasdonate_totaltag')
    ...
    models = {
        ...
        'procrasdonate.sitegroup': {
            'host': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'procrasdonate.totaluser': {
            'goals_met': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
