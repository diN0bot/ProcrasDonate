...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('procrasdonate_keyvalue', (
            ('id', orm['procrasdonate.keyvalue:id']),
            ('key', orm['procrasdonate.keyvalue:key']),
            ('value', orm['procrasdonate.keyvalue:value']),
        ))
        db.send_create_signal('procrasdonate', ['KeyValue'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('procrasdonate_keyvalue')
