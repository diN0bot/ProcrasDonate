...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaitList.group'
        db.add_column('procrasdonate_waitlist', 'group', orm['procrasdonate.waitlist:group'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'WaitList.group'
        db.delete_column('procrasdonate_waitlist', 'group')
