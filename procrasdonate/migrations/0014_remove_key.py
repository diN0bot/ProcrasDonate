...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaitList.remove_key'
        db.add_column('procrasdonate_waitlist', 'remove_key', orm['procrasdonate.waitlist:remove_key'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'WaitList.remove_key'
        db.delete_column('procrasdonate_waitlist', 'remove_key')
