...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.url'
        # (to signature: django.db.models.fields.URLField(max_length=400, db_index=True))
        db.alter_column('procrasdonate_site', 'url', orm['procrasdonate.site:url'])
