...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AggregateUser.time'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_aggregateuser', 'time', orm['procrasdonate.aggregateuser:time'])
        
        # Changing field 'AggregateRecipient.time'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_aggregaterecipient', 'time', orm['procrasdonate.aggregaterecipient:time'])
        
        # Changing field 'TagVisit.received_time'
        # (to signature: django.db.models.fields.DateTimeField(auto_now_add=True, blank=True))
        db.alter_column('procrasdonate_tagvisit', 'received_time', orm['procrasdonate.tagvisit:received_time'])
        
        # Changing field 'TagVisit.dtime'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_tagvisit', 'dtime', orm['procrasdonate.tagvisit:dtime'])
        
        # Changing field 'AggregateSiteGroup.time'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_aggregatesitegroup', 'time', orm['procrasdonate.aggregatesitegroup:time'])
        
        # Changing field 'AggregateTag.time'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_aggregatetag', 'time', orm['procrasdonate.aggregatetag:time'])
        
        # Changing field 'RecipientVisit.received_time'
        # (to signature: django.db.models.fields.DateTimeField(auto_now_add=True, blank=True))
        db.alter_column('procrasdonate_recipientvisit', 'received_time', orm['procrasdonate.recipientvisit:received_time'])
        
        # Changing field 'RecipientVisit.dtime'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_recipientvisit', 'dtime', orm['procrasdonate.recipientvisit:dtime'])
        
        # Changing field 'AggregateSite.time'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_aggregatesite', 'time', orm['procrasdonate.aggregatesite:time'])
        
        # Changing field 'Recipient.last_modified'
        # (to signature: django.db.models.fields.DateTimeField(auto_now=True, blank=True))
        db.alter_column('procrasdonate_recipient', 'last_modified', orm['procrasdonate.recipient:last_modified'])
        
        # Changing field 'SiteVisit.received_time'
        # (to signature: django.db.models.fields.DateTimeField(auto_now_add=True, blank=True))
        db.alter_column('procrasdonate_sitevisit', 'received_time', orm['procrasdonate.sitevisit:received_time'])
        
        # Changing field 'SiteVisit.dtime'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_sitevisit', 'dtime', orm['procrasdonate.sitevisit:dtime'])
        
        # Changing field 'SiteGroupVisit.received_time'
        # (to signature: django.db.models.fields.DateTimeField(auto_now_add=True, blank=True))
        db.alter_column('procrasdonate_sitegroupvisit', 'received_time', orm['procrasdonate.sitegroupvisit:received_time'])
        
        # Changing field 'SiteGroupVisit.dtime'
        # (to signature: django.db.models.fields.DateTimeField())
        db.alter_column('procrasdonate_sitegroupvisit', 'dtime', orm['procrasdonate.sitegroupvisit:dtime'])
