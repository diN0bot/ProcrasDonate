...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SiteGroup.host'
        # (to signature: django.db.models.fields.CharField(max_length=400, db_index=True))
        db.alter_column('procrasdonate_sitegroup', 'host', orm['procrasdonate.sitegroup:host'])
        
        # Changing field 'Period.startdate'
        # (to signature: django.db.models.fields.DateTimeField(db_index=True))
        db.alter_column('procrasdonate_period', 'startdate', orm['procrasdonate.period:startdate'])
        
        # Changing field 'Period.enddate'
        # (to signature: django.db.models.fields.DateTimeField(db_index=True))
        db.alter_column('procrasdonate_period', 'enddate', orm['procrasdonate.period:enddate'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SiteGroup.host'
        # (to signature: django.db.models.fields.CharField(max_length=400))
        db.alter_column('procrasdonate_sitegroup', 'host', orm['procrasdonate.sitegroup:host'])
