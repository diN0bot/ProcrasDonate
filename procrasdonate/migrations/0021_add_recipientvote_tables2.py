...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RecipientVoteVisit.recipient_vote'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['procrasdonate.RecipientVote']))
        db.alter_column('procrasdonate_recipientvotevisit', 'recipient_vote_id', orm['procrasdonate.recipientvotevisit:recipient_vote'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RecipientVoteVisit.recipient_vote'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['procrasdonate.Recipient']))
        db.alter_column('procrasdonate_recipientvotevisit', 'recipient_vote_id', orm['procrasdonate.recipientvotevisit:recipient_vote'])
