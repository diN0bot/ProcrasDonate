...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Goal.hours_saved'
        db.add_column('procrasdonate_goal', 'hours_saved', orm['procrasdonate.goal:hours_saved'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Goal.hours_saved'
        db.delete_column('procrasdonate_goal', 'hours_saved')
