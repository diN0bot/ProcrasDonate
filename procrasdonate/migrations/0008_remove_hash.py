...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'User.hash'
        db.delete_column('procrasdonate_user', 'hash')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'User.hash'
        db.add_column('procrasdonate_user', 'hash', orm['procrasdonate.user:hash'])
