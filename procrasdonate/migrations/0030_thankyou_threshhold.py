...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MetaReport.threshhold'
        db.add_column('procrasdonate_metareport', 'threshhold', orm['procrasdonate.metareport:threshhold'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'MetaReport.threshhold'
        db.delete_column('procrasdonate_metareport', 'threshhold')
    ...
    models = {
        ...
        'procrasdonate.metareport': {
            ...
            'threshhold': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
