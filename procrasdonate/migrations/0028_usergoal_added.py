...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('procrasdonate_usergoal', (
            ('id', orm['procrasdonate.usergoal:id']),
            ('user', orm['procrasdonate.usergoal:user']),
            ('period', orm['procrasdonate.usergoal:period']),
            ('is_met', orm['procrasdonate.usergoal:is_met']),
            ('hours_saved', orm['procrasdonate.usergoal:hours_saved']),
        ))
        db.send_create_signal('procrasdonate', ['UserGoal'])
        
        # Deleting field 'TotalUser.goals_met'
        db.delete_column('procrasdonate_totaluser', 'goals_met')
        
        # Deleting field 'TotalUser.hours_saved'
        db.delete_column('procrasdonate_totaluser', 'hours_saved')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('procrasdonate_usergoal')
        
        # Adding field 'TotalUser.goals_met'
        db.add_column('procrasdonate_totaluser', 'goals_met', orm['procrasdonate.totaluser:goals_met'])
        
        # Adding field 'TotalUser.hours_saved'
        db.add_column('procrasdonate_totaluser', 'hours_saved', orm['procrasdonate.totaluser:hours_saved'])
