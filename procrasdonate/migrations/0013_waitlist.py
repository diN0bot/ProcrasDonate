...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('procrasdonate_waitlist', (
            ('id', orm['procrasdonate.waitlist:id']),
            ('email', orm['procrasdonate.waitlist:email']),
            ('note', orm['procrasdonate.waitlist:note']),
            ('number_times_contacted', orm['procrasdonate.waitlist:number_times_contacted']),
            ('last_contacted_date', orm['procrasdonate.waitlist:last_contacted_date']),
            ('date_added', orm['procrasdonate.waitlist:date_added']),
        ))
        db.send_create_signal('procrasdonate', ['WaitList'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('procrasdonate_waitlist')
