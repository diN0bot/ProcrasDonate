...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.sent_initial_email'
        db.add_column('procrasdonate_user', 'sent_initial_email', orm['procrasdonate.user:sent_initial_email'])
        
        # Adding field 'User.sent_stalling_registration_email'
        db.add_column('procrasdonate_user', 'sent_stalling_registration_email', orm['procrasdonate.user:sent_stalling_registration_email'])
        
        # Adding field 'User.sent_completed_registration_email'
        db.add_column('procrasdonate_user', 'sent_completed_registration_email', orm['procrasdonate.user:sent_completed_registration_email'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.sent_initial_email'
        db.delete_column('procrasdonate_user', 'sent_initial_email')
        
        # Deleting field 'User.sent_stalling_registration_email'
        db.delete_column('procrasdonate_user', 'sent_stalling_registration_email')
        
        # Deleting field 'User.sent_completed_registration_email'
        db.delete_column('procrasdonate_user', 'sent_completed_registration_email')
