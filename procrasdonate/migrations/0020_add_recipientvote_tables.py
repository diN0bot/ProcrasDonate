...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TotalRecipientVote'
        db.create_table('procrasdonate_totalrecipientvote', (
            ('id', orm['procrasdonate.totalrecipientvote:id']),
            ('period', orm['procrasdonate.totalrecipientvote:period']),
            ('total_pledged', orm['procrasdonate.totalrecipientvote:total_pledged']),
            ('total_paid', orm['procrasdonate.totalrecipientvote:total_paid']),
            ('total_time', orm['procrasdonate.totalrecipientvote:total_time']),
            ('recipient_vote', orm['procrasdonate.totalrecipientvote:recipient_vote']),
        ))
        db.send_create_signal('procrasdonate', ['TotalRecipientVote'])
        
        # Adding model 'RecipientVoteVisit'
        db.create_table('procrasdonate_recipientvotevisit', (
            ('id', orm['procrasdonate.recipientvotevisit:id']),
            ('dtime', orm['procrasdonate.recipientvotevisit:dtime']),
            ('received_time', orm['procrasdonate.recipientvotevisit:received_time']),
            ('total_time', orm['procrasdonate.recipientvotevisit:total_time']),
            ('total_amount', orm['procrasdonate.recipientvotevisit:total_amount']),
            ('rate', orm['procrasdonate.recipientvotevisit:rate']),
            ('user', orm['procrasdonate.recipientvotevisit:user']),
            ('extn_id', orm['procrasdonate.recipientvotevisit:extn_id']),
            ('recipient_vote', orm['procrasdonate.recipientvotevisit:recipient_vote']),
        ))
        db.send_create_signal('procrasdonate', ['RecipientVoteVisit'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'TotalRecipientVote'
        db.delete_table('procrasdonate_totalrecipientvote')
        
        # Deleting model 'RecipientVoteVisit'
        db.delete_table('procrasdonate_recipientvotevisit')
    ...
    models = {
        ...
        'procrasdonate.recipientvotevisit': {
            ...
            'rate': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'received_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'recipient_vote': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['procrasdonate.Recipient']"}),
            'total_amount': ('django.db.models.fields.FloatField', [], {}),
            'total_time': ('django.db.models.fields.FloatField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['procrasdonate.User']", 'null': 'True', 'blank': 'True'})
        },
