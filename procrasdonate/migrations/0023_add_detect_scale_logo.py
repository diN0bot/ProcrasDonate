...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recipient.do_scale_logo'
        db.add_column('procrasdonate_recipient', 'do_scale_logo', orm['procrasdonate.recipient:do_scale_logo'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Recipient.do_scale_logo'
        db.delete_column('procrasdonate_recipient', 'do_scale_logo')
