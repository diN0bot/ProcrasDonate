...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Recipient.logo_width'
        db.delete_column('procrasdonate_recipient', 'logo_width')
        
        # Deleting field 'Recipient.logo_height'
        db.delete_column('procrasdonate_recipient', 'logo_height')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Recipient.logo_width'
        db.add_column('procrasdonate_recipient', 'logo_width', orm['procrasdonate.recipient:logo_width'])
        
        # Adding field 'Recipient.logo_height'
        db.add_column('procrasdonate_recipient', 'logo_height', orm['procrasdonate.recipient:logo_height'])
