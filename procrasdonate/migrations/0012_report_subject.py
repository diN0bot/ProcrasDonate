...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.subject'
        db.add_column('procrasdonate_report', 'subject', orm['procrasdonate.report:subject'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Report.subject'
        db.delete_column('procrasdonate_report', 'subject')
