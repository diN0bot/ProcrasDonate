...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MetaReport'
        db.create_table('procrasdonate_metareport', (
            ('id', orm['procrasdonate.metareport:id']),
            ('dtime', orm['procrasdonate.metareport:dtime']),
            ('recipient', orm['procrasdonate.metareport:recipient']),
            ('type', orm['procrasdonate.metareport:type']),
            ('subject', orm['procrasdonate.metareport:subject']),
            ('message', orm['procrasdonate.metareport:message']),
            ('is_draft', orm['procrasdonate.metareport:is_draft']),
        ))
        db.send_create_signal('procrasdonate', ['MetaReport'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'MetaReport'
        db.delete_table('procrasdonate_metareport')
