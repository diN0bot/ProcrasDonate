...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.org_newsletters'
        db.add_column('procrasdonate_user', 'org_newsletters', orm['procrasdonate.user:org_newsletters'])
        
        # Adding field 'User.org_thank_yous'
        db.add_column('procrasdonate_user', 'org_thank_yous', orm['procrasdonate.user:org_thank_yous'])
        
        # Adding field 'User.tos'
        db.add_column('procrasdonate_user', 'tos', orm['procrasdonate.user:tos'])
        
        # Adding field 'User.weekly_affirmations'
        db.add_column('procrasdonate_user', 'weekly_affirmations', orm['procrasdonate.user:weekly_affirmations'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'User.org_newsletters'
        db.delete_column('procrasdonate_user', 'org_newsletters')
        
        # Deleting field 'User.org_thank_yous'
        db.delete_column('procrasdonate_user', 'org_thank_yous')
        
        # Deleting field 'User.tos'
        db.delete_column('procrasdonate_user', 'tos')
        
        # Deleting field 'User.weekly_affirmations'
        db.delete_column('procrasdonate_user', 'weekly_affirmations')
